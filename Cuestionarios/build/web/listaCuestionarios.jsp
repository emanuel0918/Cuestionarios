        ...
        <div class="container center-block">
            <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        <c:forEach items="${ListaCuestionarios}" var="Cuestionario">
                            <tr>
                                <td><c:out value="${Cuestionario.nombreCuestionario}" /></td>
                                <td><c:out value="${Cuestionario.descripcionCuestionario}" /></td>
                                <td><p style="text-align: center"><a href="<c:url value="controladorCreaCuestionario?id=${Cuestionario.idCuestionario}"/>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></p></td>
                            </tr>                           
                        </c:forEach>
                    </tbody>
                </table>
